...
from Shipment_Pricing.entity.config_entity import ModelTrainerConfig
from Shipment_Pricing.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact
from Shipment_Pricing.utils.utils import save_object
...
class ModelTrainer:
    ...
    def Random_Forest_Regressor(self,x_train,y_train):
        try:
            ...
            rf = RandomForestRegressor(**rf_best_params,random_state=786)
