...
from Shipment_Pricing.entity.artifact_entity import DataTransformationArtifact
from Shipment_Pricing.entity.artifact_entity import ModelTrainerArtifact
